...
var emailEvents = map[string]bool{
	...
	events.OrderCancelRequested:     true,
	events.OrderCancelApproved:      true,
	events.OrderCancelRejected:      true,
	events.OrderDisputed:            true,
	events.OrderDisputeResolved:     true,
