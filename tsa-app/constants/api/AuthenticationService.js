...
export const registerAds=(payLoad)=>apiClient.post('/products',payLoad);
...
export const getAdverts=(type)=>apiClient.get(`/products?type=${type}`);
export const getPrduct=(id)=>apiClient.get(`/products/${id}`);
