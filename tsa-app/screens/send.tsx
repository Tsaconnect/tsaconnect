    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.methodContainer}>
              ...
              <TouchableOpacity
                style={[
                  styles.methodCard,
                  withdrawalMethod === 'onchain' && styles.selectedMethodCard
                ]}
                onPress={() => handleWithdrawalMethod('onchain')}
                activeOpacity={0.8}
              >
                <View style={styles.methodIconContainer}>
                  <Icon
                    name="link"
                    size={32}
                    color={withdrawalMethod === 'onchain' ? GOLD_COLORS.primary : '#666'}
                  />
                </View>
                <View style={styles.methodInfo}>
                  <Text style={[
                    styles.methodTitle,
                    withdrawalMethod === 'onchain' && styles.selectedMethodTitle
                  ]}>
                    On-Chain Withdraw
                  </Text>
                  <Text style={styles.methodDescription}>
                    Withdraw Crypto from TSA Connect to other exchanges
                  </Text>
                </View>
                {withdrawalMethod === 'onchain' && (
                  <Icon name="check-circle" size={24} color={GOLD_COLORS.primary} />
                )}
              </TouchableOpacity>
            </View>
          ...
          {/* Network Selection - Only for on-chain withdrawals */}
          {withdrawalMethod === 'onchain' && (
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Select Network</Text>
              <Text style={styles.sectionSubtitle}>
                Choose the blockchain network for your transaction
              </Text>

              {renderNetworkInfo()}

              {selectedAsset && networks.length > 0 ? (
                <ScrollView
                  horizontal
                ...
                <View style={styles.noNetworksContainer}>
                  <Icon name="warning" size={40} color={GOLD_COLORS.error} />
                  <Text style={styles.noNetworksText}>
                    No networks available for {selectedAsset?.symbol}
                  </Text>
                </View>
              )}
            </View>
